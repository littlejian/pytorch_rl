...
if __name__ == "__main__":
    ...
    agent = lib.agent.PolicyAgent(net.actor, apply_softmax=True, preprocessor=lib.agent.float32_preprocessor)
    exp_source = lib.experience.ExperienceSource(env, agent, steps_count=1)
