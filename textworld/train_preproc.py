...
if __name__ == "__main__":
    ...
    tgt_prep = lib.agent.TargetNet(prep)
    ...
    @engine.on(lib.ignite.PeriodEvents.ITERS_100_COMPLETED)
    def validate(engine):
        reward = 0.0
        steps = 0
    ...
    @engine.on(lib.ignite.EpisodeEvents.BEST_REWARD_REACHED)
