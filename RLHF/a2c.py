...
import lib
from lib.experience import VectorExperienceSourceFirstLast
from lib.common.utils import TBMeanTracker
import numpy as np
import argparse
import pathlib
import queue
...
def make_env_func(env_idx: int, db_path: tt.Optional[str],
    ...
    def make_env() -> gym.Env:
        ...
        e = lib.common.wrappers.wrap_dqn(e)
...
def make_test_env() -> gym.Env:
    e = gym.make("SeaquestNoFrameskip-v4")
    e = lib.common.wrappers.wrap_dqn(e, clip_reward=False)
    # add time limit after all wrappers
    e = gym.wrappers.TimeLimit(e, TIME_LIMIT)
    return e
