...
from lib.experience import ExperienceFirstLast
...
class RewardTracker:
    ...
    def reward(self, reward, steps, frame, epsilon=None):
        ...
        if self.stop_reward is not None and mean_reward > self.stop_reward:
