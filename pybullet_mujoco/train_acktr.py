...
if __name__ == "__main__":
    ...
    exp_source = lib.experience.ExperienceSourceFirstLast(envs, agent, GAMMA, steps_count=REWARD_STEPS)
    ...
    with lib.common.utils.RewardTracker(writer) as tracker:
        with lib.common.utils.TBMeanTracker(writer, batch_size=100) as tb_tracker:
